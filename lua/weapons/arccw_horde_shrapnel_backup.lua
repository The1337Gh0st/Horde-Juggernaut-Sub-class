...
if CLIENT then
    ...
    killicon.Add("arccw_horde_shrapnel_backup", "arccw/weaponicons/arccw_horde_nade_shrapnel", Color(0, 0, 0, 255))
...
SWEP.PrintName = "Juggernaut's Shrapnel Grenade"
...
--make sure that players other than the juggernaut can't use this
